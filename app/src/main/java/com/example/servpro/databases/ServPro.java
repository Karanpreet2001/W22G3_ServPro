...
import com.example.servpro.interfaces.CoordinateDao;
...
@Database(entities = {Customer.class, ServiceProvider.class, Coordinates.class}, version = 1, exportSchema = false)
...
public abstract class ServPro extends RoomDatabase {
    ...
    public  abstract CoordinateDao coordinatesDao();
}
